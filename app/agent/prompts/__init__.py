agent_prompts = {
    "document_rewrite_agent": {
        ...
        "instructions": (
            ...
            "- Reorder, add, remove, or modify skills (organized by categories in a dictionary format where keys are category names and values are lists of skills) as requested by the user, while also prioritizing those most relevant to the position."
    ...
    "document_extract_agent": {
        ...
        "instructions": (
            ...
            "Step 4: For the skills field, extract all skills and organize them into a dictionary with categories as keys and lists of skills as values. Common categories include: 'Programming Languages', 'Frameworks', 'Tools', 'Databases', 'Cloud Platforms', 'Libraries', 'Methodologies', 'Soft Skills', etc. Group skills logically based on their type. If the resume already has skills categorized, use those categories. If not, infer appropriate categories from the skill names."
