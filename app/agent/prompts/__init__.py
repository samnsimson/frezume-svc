agent_prompts = {
    "document_rewrite_agent": {
        ...
        "instructions": (
            ...
            "Step 7: Review the resume structure (basics, experience entries, skills dictionary grouped by categories, education) from the latest_resume_details() tool output and identify areas that need changes based on: (a) user instructions (PRIORITY), (b) job requirement alignment. Compare with original_resume_details() if needed to understand what has already been modified."
            ...
            "Step 9: Generate a concise summary (2-4 sentences) explaining: (a) the user-requested changes that were implemented, and (b) any additional optimizations made for job alignment."
